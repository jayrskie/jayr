...
try {
    ...
    $book_copy_id = isset($config['book_copy_id']) ? intval($config['book_copy_id']) : null;
    ...
    if ($borrow_type === 'takehome') {
        ...
        // For classroom use, due date is same day as borrow date
        $new_due_date = $book['borrow_date'];
    }
