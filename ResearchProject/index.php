  ...
  <script>
    ...
    function borrowBook(bookId) {
      ...
      if (isLoggedIn) {
        ...
        modalMessage.textContent = 'Your borrow request will be sent to the librarians for approval. Head to library in order to claim it.';
      ...
      fetch('borrow_request.php', {
        ...
        .then(data => {
          if (data.success) {
            ...
            const modalError = document.getElementById('modalError');
            modalError.classList.remove('active');
            modalSuccess.textContent = 'Borrow request submitted!';
