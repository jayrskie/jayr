        ...
        .then(data => {
          if (data.success && data.requests && data.requests.length > 0) {
            ...
            data.requests.forEach(request => {
              ...
              if (status === 'pending') {
                html += `
                  <button class="btn-approve" data-action="approve" onclick="openConfigureModalFromPending(${request.id}, &quot;${escapeHtml(request.book_title)}&quot;, &quot;${escapeHtml(request.user_name)}&quot;, &quot;${escapeHtml(request.author)}&quot;, '${request.is_guest}', ${request.book_id})">Configure</button>
                `;
              }
