    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li class="clicked-page"><a href="admin-manage-users.php"><img class="nav-icon" src="../images/calendar.png" alt="Users"> <span class="nav-text">User Management</span></a></li>
