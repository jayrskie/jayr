...
try {
    ...
    if ($isAdmin) {
        ...
        $query = 'SELECT rh.id, rh.user_id, rh.book_id, rh.book_title, rh.borrow_date, rh.return_date, rh.return_status, u.library_id, u.username 
        ...
        $query = 'SELECT id, user_id, book_id, book_title, borrow_date, return_date, return_status 
                  FROM return_history 
                  WHERE user_id = ?
