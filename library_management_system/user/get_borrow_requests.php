...
if (empty($searchQuery)) {
    ...
    $stmt = $conn->prepare("SELECT br.id, br.user_id, u.library_id, u.username, br.book_id, br.book_title, br.status, br.created_at, br.updated_at, br.requested_duration
