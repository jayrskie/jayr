(function(){
    ...
    function showBorrowModal(bookId, bookTitle) {
        ...
        document.getElementById('borrowDays').focus();
    }
    ...
    document.getElementById('closeModal').addEventListener('click', hideBorrowModal);

    document.getElementById('borrowModal').addEventListener('click', (e) => {
        if (e.target === document.getElementById('borrowModal')) {
            hideBorrowModal();
        }
    });
