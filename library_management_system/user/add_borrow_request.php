...
$stmt = $conn->prepare('INSERT INTO borrow_requests (user_id, book_id, book_title, status, requested_duration) VALUES (?, ?, ?, ?, ?)');
$status = 'requested';
$stmt->bind_param('iissi', $userId, $bookId, $bookTitle, $status, $duration);
